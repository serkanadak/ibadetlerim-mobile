...
> Sünni itikat (Hanefi fıkhı esaslı) günlük, haftalık ve yıllık farz, vacip ve sünnet ibadet takibi; geçmiş kaza namazları defteri ve veri kaybı korumalı yerel hafıza.
...
| Alan | Değer |
| :--- | :--- |
| **Uygulama Adı** | İbadetlerim |
| **Paket / Bundle ID** | `com.serkanadak.ibadetlerim` |
| **Kategori** | Yaşam Tarzı / Üretkenlik |
...
- ✅ **Günlük Farz, Vacip ve Sünnet-i Müekkede İbadet Çetelesi**
- ✅ **Kapsamlı Geçmiş Kaza Namazları Takip Defteri & Toplu İşaretleme**
- ✅ **Kesintisiz Seri (Streak) ve Tamamlanma İstatistik Grafikleri**
- ✅ **Hac, Umre, Zekât ve Kurban Periyodik İbadet Rehberi**
- ✅ **Tek Dokunuşla Yerel Yedekleme & Derin Tarama Veri Koruması**
...
```bash
# 1. Depoyu klonlayın
git clone https://github.com/serkanadak/ibadetlerim-mobile.git
cd ibadetlerim-mobile
